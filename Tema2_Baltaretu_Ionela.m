%Semnal triunghiular cu perioada T=40, durata semnalului D=2
...
x=abs(sawtooth(w*t,0.05));

%Deoarece, pentru D=T/2=20, avem xmax=0.5, atunci pentru D=2, avem
%xmax=0.05
...
C(k+N+1) = integral(@(t)((abs(sawtooth(w*t,0.05))+sawtooth(w*t,0.05)))/2.*exp(-1j*k*w*t),0,T);
